...
3. legend section card (`headerStyle="legend"`) มี `margin-top: var(--sp-2xl)` built-in เพื่อเว้นพื้นที่ให้ chip title ที่คร่อมขอบบน — padding ภายใน card มาจาก `card-base` (`var(--sp-xl)`) เท่ากันทุก box ห้าม override
