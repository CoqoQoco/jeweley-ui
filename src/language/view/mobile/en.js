...
export const sale = {
  ...
  invoiceCancelConfirmItemsMsg: '{count} item(s) will be returned to stock',
  invoiceCancelConfirmPaymentWarningMsg: 'This invoice has {count} payment record(s) totalling {amount} {currency} — they will be cancelled as well',
  invoiceCancelConfirmIrreversibleMsg: 'This action cannot be undone',
  invoiceCancelConfirmBtn: 'Cancel Both Documents',
  invoiceCancelConfirmTitle: 'Confirm Cancel',
  invoiceCancelSuccessMsg: 'Invoice and sale order cancelled successfully',
  invoiceCancelSuccessWithPaymentMsg: 'Invoice, sale order and {count} payment record(s) cancelled successfully',
  invoiceCancelSuccessTitle: 'Success',

  // invoice-detail-view — record payment
  invoiceRecordPaymentBtn: 'Record Payment',
  invoiceDeletePaymentBtn: 'Delete Payment',
  invoiceConfirmDeletePaymentTitle: 'Confirm Delete Payment',
  invoiceConfirmDeletePaymentMsg: 'Delete payment of {amount} {currency} dated {date}? This action cannot be undone.',
  invoiceConfirmDeletePaymentBtn: 'Delete',
  invoiceDeletePaymentSuccessMsg: 'Payment deleted successfully',
  invoicePaymentSuccessMsg: 'Payment recorded successfully',

  // payment-record-sheet
  invoicePaymentSheetTitle: 'Record Payment',
  invoicePaymentSheetOutstandingLabel: 'Outstanding',
  invoicePaymentSheetDateLabel: 'Payment Date',
  invoicePaymentSheetDatePlaceholder: 'Select payment date',
  invoicePaymentSheetAmountLabel: 'Amount',
  invoicePaymentSheetMethodLabel: 'Payment Method',
  invoicePaymentSheetMethodPlaceholder: 'Select payment method',
  invoicePaymentSheetBankLabel: 'Bank',
  invoicePaymentSheetBankPlaceholder: 'Select bank',
  invoicePaymentSheetBranchLabel: 'Bank Branch',
  invoicePaymentSheetBranchPlaceholder: 'Enter bank branch',
  invoicePaymentSheetReferenceLabel: 'Reference Number',
  invoicePaymentSheetReferencePlaceholder: 'Enter reference number (optional)',
  invoicePaymentSheetRemarkLabel: 'Remark',
  invoicePaymentSheetRemarkPlaceholder: 'Enter remark (optional)',
  invoicePaymentSheetImageLabel: 'Receipt Image',
  invoicePaymentSheetCaptureBtn: 'Take Receipt Photo',
  ...
  invoicePaymentSheetWarnBankRequired: 'Please select a bank',
  invoicePaymentSheetWarnBranchRequired: 'Please enter a bank branch',
  invoicePaymentSheetConfirmOverpayTitle: 'Confirm Amount Exceeds Outstanding',
  invoicePaymentSheetConfirmOverpayMsg: 'The amount entered {amount} {unit} exceeds the outstanding balance {outstanding} {unit}. Continue?',
