...
export const pos = {
  ...
  // customer chip — suggest ลูกค้าเดิมขณะพิมพ์
  suggestListTitle: 'ลูกค้าเดิมที่ตรงกัน แตะเพื่อเลือก',
  confirmCreateDespiteMatchTitle: 'ยืนยันสร้างลูกค้าใหม่',
  confirmCreateDespiteMatchMsg: 'มีลูกค้าเดิมที่ชื่อ/เบอร์คล้ายกัน {count} ราย ต้องการสร้างลูกค้าใหม่ใช่หรือไม่?',
  confirmCreateDespiteMatchBtn: 'สร้างใหม่',
  ...
  // checkout sheet — ยืนยันรับเงินได้เลยไม่ต้องกดเพิ่มรายการชำระ
  confirmPaymentBtnWithAmount: 'ยืนยันรับเงิน {amount} {unit}',
  entryHint: 'กด "ยืนยันรับเงิน" ได้เลย — กด "เพิ่มรายการชำระ" เฉพาะเมื่อแบ่งจ่ายหลายวิธี',
  confirmNoPaymentTitle: 'ยังไม่มีรายการรับชำระ',
  confirmNoPaymentMsg: 'บิลนี้จะถูกบันทึกเป็นค้างชำระทั้งจำนวน {amount} {unit} ต้องการดำเนินการต่อหรือไม่?',
  confirmNoPaymentBtn: 'บันทึกเป็นค้างชำระ',
  confirmNoPaymentCancelBtn: 'กลับไปรับเงิน',
...
export const sale = {
  ...
  invoiceCancelBtn: 'ยกเลิกใบแจ้งหนี้ + ใบสั่งขาย',
  ...
  invoiceCancelConfirmItemsMsg: 'สินค้า {count} รายการจะถูกคืนกลับเข้าคลัง',
  invoiceCancelConfirmPaymentWarningMsg: 'ใบนี้มีรายการรับชำระเงิน {count} รายการ ยอดรวม {amount} {currency} — จะถูกยกเลิกไปด้วย',
  invoiceCancelConfirmIrreversibleMsg: 'การกระทำนี้ย้อนกลับไม่ได้',
  invoiceCancelConfirmBtn: 'ยกเลิกทั้งสองใบ',
  invoiceCancelConfirmTitle: 'ยืนยันการยกเลิก',
  invoiceCancelSuccessMsg: 'ยกเลิกใบแจ้งหนี้และใบสั่งขายเรียบร้อยแล้ว',
  invoiceCancelSuccessWithPaymentMsg: 'ยกเลิกใบแจ้งหนี้ ใบสั่งขาย และรายการรับชำระเงิน {count} รายการ เรียบร้อยแล้ว',
  invoiceCancelSuccessTitle: 'สำเร็จ',

  // invoice-detail-view — บันทึกรับเงิน
  invoiceRecordPaymentBtn: 'บันทึกรับเงิน',
  invoiceDeletePaymentBtn: 'ลบรายการชำระ',
  invoiceConfirmDeletePaymentTitle: 'ยืนยันลบรายการชำระ',
  invoiceConfirmDeletePaymentMsg: 'ต้องการลบรายการชำระ {amount} {currency} วันที่ {date} ใช่หรือไม่ครับ? การลบไม่สามารถย้อนกลับได้',
  invoiceConfirmDeletePaymentBtn: 'ลบรายการ',
  invoiceDeletePaymentSuccessMsg: 'ลบรายการชำระเรียบร้อยแล้วครับ',
  invoicePaymentSuccessMsg: 'บันทึกรับเงินเรียบร้อยแล้วครับ',

  // payment-record-sheet
  invoicePaymentSheetTitle: 'บันทึกรับเงิน',
  invoicePaymentSheetOutstandingLabel: 'ยอดคงค้าง',
  invoicePaymentSheetDateLabel: 'วันที่รับเงิน',
  invoicePaymentSheetDatePlaceholder: 'เลือกวันที่รับเงิน',
  invoicePaymentSheetAmountLabel: 'จำนวนเงิน',
  invoicePaymentSheetMethodLabel: 'วิธีชำระ',
  invoicePaymentSheetMethodPlaceholder: 'เลือกวิธีชำระ',
  invoicePaymentSheetBankLabel: 'ธนาคาร',
  invoicePaymentSheetBankPlaceholder: 'เลือกธนาคาร',
  invoicePaymentSheetBranchLabel: 'สาขาธนาคาร',
  invoicePaymentSheetBranchPlaceholder: 'กรอกสาขาธนาคาร',
  invoicePaymentSheetReferenceLabel: 'เลขที่อ้างอิง',
  invoicePaymentSheetReferencePlaceholder: 'กรอกเลขที่อ้างอิง (ถ้ามี)',
  invoicePaymentSheetRemarkLabel: 'หมายเหตุ',
  invoicePaymentSheetRemarkPlaceholder: 'กรอกหมายเหตุ (ถ้ามี)',
  invoicePaymentSheetImageLabel: 'รูปสลิป',
  invoicePaymentSheetCaptureBtn: 'ถ่ายรูปสลิป',
  ...
  invoicePaymentSheetWarnBankRequired: 'กรุณาเลือกธนาคารครับ',
  invoicePaymentSheetWarnBranchRequired: 'กรุณากรอกสาขาธนาคารครับ',
  invoicePaymentSheetConfirmOverpayTitle: 'ยืนยันจำนวนเงินเกินยอดคงค้าง',
  invoicePaymentSheetConfirmOverpayMsg: 'จำนวนเงินที่กรอก {amount} {unit} มากกว่ายอดคงค้าง {outstanding} {unit} ต้องการดำเนินการต่อหรือไม่ครับ?',
  ...
  topics: [
    ...
    },
    {
      ...
      list: [
        ...
        {
          label: 'พิมพ์รหัส',
          desc: 'พิมพ์รหัสสินค้าใหม่หรือรหัสเก่าก็ได้แล้วกด Enter ระบบค้นให้อัตโนมัติทั้งสองแบบ'
        },
        {
    ...
    },
    {
      ...
      list: [
        ...
        {
          desc: 'พิมพ์ชื่อหรือเบอร์ (≥ 6 หลัก) ระบบโชว์ลูกค้าเดิมที่ตรงกันใต้ช่องกรอก แตะเพื่อเลือกได้เลย'
        }
      ],
    ...
    },
    {
      ...
      list: [
        ...
        { desc: 'จ่ายวิธีเดียว: เลือกวิธี ใส่ยอด แล้วกด "ยืนยันรับเงิน" ได้เลย (ไม่ต้องกด "เพิ่มรายการชำระ")' },
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          [
            'ไม่พบข้อมูลสินค้า',
            'รหัสที่กรอกไม่ตรงกับรหัสสินค้าใหม่หรือรหัสเก่าเลย',
            'ตรวจสอบรหัสบนป้ายอีกครั้งแล้วลองใหม่'
          ],
          [
            'สินค้าชิ้นนี้ถูกขายไปแล้ว / ถูกจองไว้ในบิลอื่นแล้ว',
            'ระบบเช็คสถานะสินค้าให้ทันทีตอนสแกน',
            'เอาชิ้นนี้ออก ให้ลูกค้าเลือกชิ้นอื่นแทน'
          ],
          [
