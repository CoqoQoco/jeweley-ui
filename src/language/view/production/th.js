export default {
  ...
  planGold: {
    ...
    emptyReturnBody: 'ยังไม่มีรายการคืนตัวเรือน',
    ...
    editTitle: 'แก้ไขใบเบิกผสมทอง',
    labelNo: 'เลขที่:',
    labelBookNo: 'เล่มที่:',

    errorAssignDateRequired: 'กรุณาระบุวันที่เบิก',
    errorGoldRequired: 'กรุณาเลือกประเภททอง',
    errorGoldSizeRequired: 'กรุณาเลือกเปอร์เซ็นทอง',
    errorMissingWoRows: 'แถวที่ {rows} ยังไม่ได้เลือก WO',
    validationTitle: 'กรุณาตรวจสอบข้อมูล',

    balanceMeltTitle: 'สมดุลทองหลอม',
    balanceCastTitle: 'สมดุลทองหล่อ',
    balanceIssued: 'เบิก',
    balanceReturned: 'คืนรวม',
    balanceDiff: 'ต่าง',
    balanceShort: 'ขาด',
    balanceOver: 'เกิน',
    balanceApply: 'ใช้ค่านี้',

    clearFormTitle: 'ยืนยันล้างฟอร์ม',
    clearFormConfirm: 'ต้องการล้างข้อมูลในฟอร์มทั้งหมดหรือไม่?',
    leaveTitle: 'ยืนยันออกจากหน้านี้',
    leaveWarning: 'มีข้อมูลที่ยังไม่บันทึก ต้องการออกจากหน้านี้หรือไม่?'
  },
  ...
  goldLossTang: {
    ...
    manualCountInLossNote: 'ติ๊ก "คิด %Loss" ในรายการคืนสำหรับงานที่ไม่มี Job (งานซ่อม / งานส่ง) เพื่อให้น้ำหนักงานนั้นเข้าฐานคำนวณ %Loss ด้วย ไม่ต้องติ๊กสำหรับ ทองก้อน / เศษทอง / ลวด / น้ำประสาน / คืนตัวเรือนที่ไม่ได้ทำ',
    ...
    countInCalc: 'คิด',
    countInLoss: 'คิด %Loss',
    lossBaseLabel: 'ฐานคำนวณ %Loss',
    notCounted: 'ไม่นำมาคิด',
    printTitle: 'พิมพ์เอกสาร',
    printAttachWoQuestion: 'ต้องการแนบรายละเอียดใบงาน (WO) ท้ายเอกสารหรือไม่?',
    printWithWo: 'แนบรายละเอียด WO',
    printSummaryOnly: 'เฉพาะสรุป',
    addManualJob: '+ เพิ่มงานเอง',
    manualJobBadge: 'เพิ่มเอง',
    manualJobModalTitleAdd: 'เพิ่มงานเอง',
    manualJobModalTitleEdit: 'แก้ไขงานเพิ่มเอง',
    manualJobDeleteConfirm: 'ยืนยันการลบงานเพิ่มเอง',
    manualFieldWo: 'เลขที่งาน / ชื่องาน',
    manualFieldWoNumber: 'ลำดับ',
    manualFieldJobDate: 'วันที่',
    manualFieldGold: 'ทอง',
    manualFieldGoldSize: 'ขนาดทอง',
    manualFieldGoldWeightSend: 'น้ำหนักจ่าย (g)',
    manualFieldGoldWeightCheck: 'น้ำหนักรับ (g)',
  ...
  leadTime: {
    ...
    colBGt365: '>365',
    totalLabel: 'รวม',
    tabOverall: 'ภาพรวมทั้งใบงาน',
    tabStage: 'แยกตามแผนก',
    stage: {
      searchTitle: 'รายงาน Lead-time แยกตามแผนก',
      searchDesc: 'เลือกช่วงวันที่เสร็จและเงื่อนไขอื่นๆ เพื่อดู Lead-time แยกตามแผนกผลิตครับ',
      groupByOptionNone: 'ไม่แยก',
      groupByOptionGold: 'ชนิดทอง',
      groupByOptionGoldSize: 'ขนาดทอง',
      breakdownChartTitle: 'จำนวนวันเฉลี่ยต่อใบงาน แยกตาม{dimension}',
      breakdownChartSeries: 'จำนวนวันเฉลี่ยต่อใบงาน (วัน)',
      breakdownTableTitle: 'ตารางเปรียบเทียบ Lead-time แยกตาม{dimension} และแผนก',
      colPlanCount: 'จำนวนใบงาน',
      colAvgTotalDays: 'จำนวนวันเฉลี่ยต่อใบงาน (วัน)',
      lowVolumeCaveat: 'กลุ่มที่มีจำนวนใบงานน้อยกว่า {threshold} ใบ อาจมีค่าเฉลี่ยที่ไม่น่าเชื่อถือ แสดงจางลงในกราฟและตารางเพื่อให้สังเกตได้ง่ายครับ',
      sheetBreakdown: 'แยกตาม{dimension}',
      gold: 'สีทอง/เงิน',
      goldSize: 'ประเภททอง/เงิน',
      customerCode: 'รหัสลูกค้า',
      mold: 'แม่พิมพ์',
      productNumber: 'รหัสสินค้า',
      text: 'ค้นหา (W.O./สินค้า)',
      textPlaceholder: 'เลขที่ W.O. หรือรหัสสินค้า',
      statCompleted: 'งานเสร็จรวม',
      statMedianTotal: 'Lead-time รวม กลาง (Median)',
      statBottleneck: 'แผนกคอขวด (สัดส่วนเวลาสูงสุด)',
      statNoStage: 'งานที่ไม่ผ่านแผนกผลิตเลย',
      chartAvgTitle: 'จำนวนวันเฉลี่ยที่งานอยู่ในแต่ละแผนก',
      chartAvgSeries: 'จำนวนวันเฉลี่ย (วัน)',
      summaryLine: 'ใบงาน 1 ใบใช้เวลาตั้งแต่เริ่มจนจบเฉลี่ย {avgTotalLeadDays} วัน — แผนกที่ใช้เวลามากที่สุดคือ {bottleneckStatusName} ครับ',
      toggleDetailLabel: 'แสดงรายละเอียดเชิงลึก',
      mainTableTitle: 'สรุป Lead-time แยกตามแผนก',
      workDaysCaveat: 'ตัวเลข "เวลาโหลดงาน" อ้างอิงจากเวลาบันทึกแก้ไขในระบบ ซึ่งบางแผนกอาจไม่แม่นยำ โปรดดูเปอร์เซ็นต์ความน่าเชื่อถือประกอบการตัดสินใจเสมอ ไม่ควรใช้เป็นตัวเลขยืนยันครับ',
      colDept: 'แผนก',
      colVisitCount: 'จำนวนงานที่ผ่าน',
      colMedianDays: 'มัธยฐาน (วัน)',
      colP90Days: 'P90 (วัน)',
      colAvgDays: 'จำนวนวันเฉลี่ย',
      colShare: 'สัดส่วนเวลา (%)',
      colMedianWorkDays: 'เวลาโหลดงาน (วัน)',
      colReliability: 'ความน่าเชื่อถือ (%)',
      wipTitle: 'งานค้างอยู่ตอนนี้',
      colWipCount: 'จำนวนงานค้าง',
      colAvgAgeDays: 'อายุเฉลี่ย (วัน)',
      colMaxAgeDays: 'อายุสูงสุด (วัน)',
      topStuckTitle: 'งานค้างนานที่สุด 10 อันดับ',
      colWoText: 'เลขที่ W.O.',
      colProductName: 'ชื่อสินค้า',
      colCustomerName: 'ชื่อลูกค้า',
      colAgeDays: 'ค้างมาแล้ว (วัน)',
      colRequestDate: 'วันกำหนดส่ง',
      sheetMain: 'สรุปแยกตามแผนก',
      sheetWip: 'งานค้างปัจจุบัน',
      sheetTopStuck: 'ค้างนานสุด 10 อันดับ',
      excelFileName: 'รายงาน-lead-time-แยกตามแผนก',
  ...
  goldLossByWorkerAllStages: {
    searchTitle: 'รายงานส่วนต่างทองต่อช่าง (ทุกแผนก)',
    searchDesc: 'ดูส่วนต่างทองจ่าย-รับคืนของช่างแยกตามแผนก เทียบได้เฉพาะช่างในแผนกเดียวกันเท่านั้น',
    dateRange: 'ช่วงวันที่',
    department: 'แผนก',
    gold: 'ประเภททอง',
    workerCode: 'ช่าง',
    ...
    statJobs: 'จำนวนงาน',
    statPeriod: 'ช่วงเวลาที่ดู',
    statMissingWorker: 'สัดส่วนงานไม่ระบุช่าง',
    monthlyTopTitle: 'ช่างที่สูงสุดในแต่ละเดือน',
    colYearMonth: 'เดือน',
    colDept: 'แผนก',
    colWorkerCode: 'รหัสช่าง',
    colWorkerName: 'ชื่อช่าง',
    colLossPercent: '%ส่วนต่าง',
    colJobCount: 'จำนวนงาน',
    mainTableTitle: 'ตารางสรุปช่างทั้งหมด',
    colSumSend: 'นน.จ่ายรวม',
    colSumCheck: 'นน.รับคืนรวม',
    colRawLoss: 'นน.ส่วนต่าง (จ่าย-รับคืน)',
    colStageAvg: '%เฉลี่ยแผนก',
    colDiffFromAvg: 'ส่วนต่างจากค่าเฉลี่ยแผนก (%)',
    colRank: 'อันดับในแผนก',
    badgeBelowMinJobs: 'งานน้อยกว่าเกณฑ์',
    chartTitle: 'แนวโน้ม %ส่วนต่างรายเดือนต่อช่าง',
    unitPercent: '%',
    unitGram: 'g',
  ...
  goldLossDashboard: {
    ...
    overview: {
      ...
      monthlyGuide: {
        toggleShow: 'วิธีอ่านตารางนี้',
        toggleHide: 'ซ่อนวิธีอ่าน',
        columnsTitle: 'ความหมายแต่ละคอลัมน์ ({dept})',
        termSlipCount: 'ใบ',
        descSlipCount: 'จำนวนใบในเดือนนั้น',
        termIssuedReturned: 'เบิก / คืน (g)',
        descIssuedReturned: 'ทองที่จ่ายให้ช่าง / ทองที่ช่างส่งคืน',
        termLoss: 'Loss (g)',
        descLoss: 'ทองที่หายจริง = เบิก − คืน',
        termLossPercent: '%loss',
        descLossPercent: 'Loss ÷ เบิก × 100',
        termAllowed: 'ยอมให้ (g)',
        termAllowedPercent: 'ยอมให้ %',
        termOverAllowed: 'เกินที่ยอมให้ (g)',
        descOverAllowed: 'Loss − ยอมให้',
        overAllowedHint: 'ติดลบ = หายน้อยกว่าเกณฑ์ (ดี) · ค่าบวกแสดงเป็นตัวแดง = หายเกินเกณฑ์',
        tang: {
          descAllowed: 'ผลรวมของทุกใบ — ใบละ น้ำหนักคืนตัวงาน × %loss ที่ตั้งในใบ (ไม่นับบรรทัดเพิ่มเติมที่คีย์เอง)',
          descAllowedPercent: 'ยอมให้รวม ÷ น้ำหนักคืนตัวงานรวม × 100 (เฉลี่ยถ่วงน้ำหนักตามน้ำหนักทอง)'
        },
        setter: {
          descAllowed: 'ผลรวมของทุกชิ้นงาน — ชิ้นละ น้ำหนักคืน × %loss ของชิ้นนั้น',
          descAllowedPercent: 'ยอมให้รวม ÷ น้ำหนักคืนรวม × 100 (เฉลี่ยถ่วงน้ำหนักตามน้ำหนักทอง)'
        },
        weightedTitle: 'ยอมให้ % ไม่ใช่ค่าเฉลี่ยธรรมดา',
        exampleA: 'ใบ A  คืน 100 g  ตั้ง 3%  → ยอมให้ 3.00 g',
        exampleB: 'ใบ B  คืน 10 g  ตั้ง 5%  → ยอมให้ 0.50 g',
        exampleResult: 'เฉลี่ยธรรมดา (3% + 5%) ÷ 2 = 4% ✗   ·   ถ่วงน้ำหนัก 3.50 ÷ 110 = 3.18% ✓ (ตารางนี้ใช้แบบนี้)',
        noteCompare: '%loss กับ ยอมให้ % หารคนละฐาน อย่าเทียบกันตรง ๆ — ให้ดูคอลัมน์ "เกินที่ยอมให้ (g)" แทน',
        noteZero: 'แถวที่เป็น 0 ทั้งแถว = เดือนในช่วงที่เลือกแต่ไม่มีใบ · "—" = ไม่มีฐานให้คำนวณ',
        noteExpand: 'กด > หน้าแถว เพื่อดูแยกรายช่าง (เรียง Loss มากสุดก่อน) — ยอดแถวเดือน = ผลรวมของช่างในเดือนนั้น',
        noteTotal: 'แถว "รวมทั้งช่วง" คำนวณ % จากยอดรวมทั้งช่วง ไม่ได้เอา % รายเดือนมาเฉลี่ย'
      },
