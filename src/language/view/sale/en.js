...
export const invoiceDetail = {
  ...
  paymentStatusPaid: 'Fully Paid',
  paymentStatusPartial: 'Partially Paid',
  paymentStatusUnpaid: 'Unpaid',
  paymentProgressLine: 'Paid {paid} / {total}',
  freightInsuranceRow: 'Freight / Insurance',
  vatPercentRow: 'VAT {percent}%',
  moneySummaryFootnote: "{currency} {'@'} {rate} · rounded {rounding}",
  moneySummaryToggle: 'View financial summary details',
  ...
  previewTitleWithPaper: 'Print Preview — {paper}',
  previewZoomLabel: 'Zoom',
  previewZoomFit: 'Fit width',
  previewPageLabel: 'Page {current}/{total}',
  previewGridToggle: 'Show grid',
  previewPrintNowBtn: 'Print now',
  previewOffsetLabel: 'Offset X: {x} mm / Y: {y} mm',
  ...
  success: {
    ...
    summaryPdf: 'Summary PDF created successfully',
    summaryExcel: 'Summary Excel exported successfully',
    cancelInvoice: 'Invoice cancelled successfully',
    cancelInvoiceTitle: 'Invoice has been cancelled',
    cancelInvoiceUnconfirmTitle: 'Invoice has been cancelled and items unconfirmed',
    cancelInvoiceUnconfirm: 'Invoice cancelled and {count} item(s) unconfirmed successfully',
  ...
  confirm: {
    ...
    cancelPaymentWarning: 'This invoice has {amount} {currency} in payments that will be cancelled too',
  ...
  confirmOverpayTitle: 'Confirm Amount Exceeds Outstanding',
  confirmOverpayMsg: 'The amount entered {amount} {unit} exceeds the outstanding balance {outstanding} {unit}. Continue?',
...
export const quotation = {
  ...
  success: {
    ...
    exportSummaryExcel: 'Summary Excel exported successfully',
...
export const saleOrder = {
  ...
  priority: 'Priority',
  salePerson: 'Salesperson (SALE)',
  saleSupport: 'Sales Support (SUPPORT)',
  selectSalePersonPlaceholder: 'Select or type a name',
  currency: 'Currency',
  ...
  maxDeposit: 'Max',
  depositApplyLabel: 'Deduct Deposit',
  depositBalanceHint: 'Remaining SO deposit balance {balance}',
  paymentMethod: 'Payment Method',
  ...
  qtyAvailableCol: 'Available',
  qtyAvailableHint: 'Available {n}',
  qtyShortage: 'Short {k}',
  qtySoldOut: 'Sold out',
  shortageWarningTitle: 'Items exceeding available stock',
  shortageWarningLine: '{stockNumber} ({origin}) short by {shortage}',
  btnAdjustToAvailable: 'Adjust to available qty',
  ...
  fillFromStockModalTitle: 'Fill from Stock',
  fillFromStockStockNumberLabel: 'Stock Number (scan/enter)',
  ...
  confirm: {
    ...
    adjustToAvailableTitle: 'Confirm quantity adjustment',
    adjustToAvailableMessage: 'The system will adjust {count} short item(s) to the available quantity, e.g. {stockNumber} from {oldQty} to {newQty}. The shortage will be automatically added as a pending production/conversion line.',
...
export const soDeposit = {
  ...
  totalApplied: 'Applied to Invoices',
  balance: 'Balance',
  percentOfTotal: '{percent}% of order total',
  receiveBtn: 'Receive Deposit',
  printReceiptBtn: 'Print Deposit Receipt',
  deleteBtn: 'Delete',
  showDeletedToggle: 'Show deleted entries',
  emptyList: 'No deposit received yet',
  colDate: 'Date',
  colAmount: 'Amount',
  colMethod: 'Method',
  colBankRef: 'Bank / Reference',
  colSlip: 'Slip',
  colRemark: 'Remark',
  colApplied: 'Applied',
  colRemaining: 'Remaining',
  colAppliedInvoices: 'Applied Invoices',
  deletedBadge: 'Deleted',
  deletedReasonPrefix: 'Reason',
  appliedLockHint: 'Already applied to an invoice — cannot delete',
  noPermissionHint: 'No permission to manage deposit',

  modalTitle: 'Receive Deposit',
  soGrandTotalLabel: 'Sale Order Grand Total',
  ...
  deleteReasonTitle: 'Reason for deleting deposit',
  deleteReasonLabel: 'Reason',
  deleteReasonPlaceholder: 'Specify the reason for deleting this deposit entry',

  validation: {
    dateRequired: 'Please select the deposit date',
    amountRequired: 'Please enter a deposit amount greater than 0',
    methodRequired: 'Please select a payment method',
    bankRequired: 'Please select a bank',
    branchRequired: 'Please enter the bank branch',
    compressError: 'Unable to compress the image',
    deleteReasonRequired: 'Please specify the reason for deleting this deposit'
  },
  confirm: {
    deleteMessage: 'Delete deposit {amount} {currency} dated {date}',
    deleteTitle: 'Confirm deleting this deposit entry?'
  },
  success: {
    create: 'Deposit received successfully',
    delete: 'Deposit deleted successfully'
  }
}
...
export const costStock = {
  ...
  calcGoldPerGram: 'Calculate Gold Price/Gram',
  ...
  alloyGoldLossTooltip: 'Alloy weight already includes Gold Loss — no need to apply it again',
  costPrefix: 'Cost: ',
  historyBadge: 'Recently used',
  gradeSyncTitle: 'Diamond grade changed',
  gradeSyncDetail: 'Row {count}: "{from}" will change to "{to}"',
  gradeSyncApply: 'Update to match',
  gradeSyncDismiss: 'Dismiss',
  gradeSyncManualHint: 'Diamond grade changed, but this row needs manual edit',
  gradeSyncDone: 'Diamond grades in the appraisal table updated',
...
export const pipelineDashboard = {
  ...
  subtitle: 'Sales by invoice date · converted to THB',
  searchTitle: 'Search Sales Overview',
  searchDesc: 'Filter sales by invoice date, sale channel, and customer',
  dateRangeLabel: 'Invoice Date',
  channelLabel: 'Sale Channel',
  channelNotSpecified: 'Not specified',
  customerLabel: 'Customer',
  customerPlaceholder: 'Search customer name',
  customerOptionInvoiceCount: '{count} invoice(s)',
  summaryTitle: 'Sales (THB)',
  kpiTotalAmount: 'Total Sales',
  kpiTotalAmountSub: 'Converted to THB at invoice rate',
  kpiPaidAmount: 'Paid',
  kpiPaidAmountSub: '{count} invoice(s) fully paid',
  kpiOutstandingAmount: 'Outstanding',
  kpiOutstandingAmountSub: '{count} invoice(s)',
  kpiInvoiceCount: 'Invoice Count',
  kpiInvoiceCountSub: '{count} piece(s)',
  uncomputableNote: '{count} old invoice(s) have no total and are excluded from the amounts above',
  overpaidNote: '{count} invoice(s) have payments recorded above the invoice total, {amount} THB in all — please review the payment records',
  productGroupTitle: 'Best-Selling Product Groups',
  groupByLabel: 'Group By',
  groupByProductType: 'Product Type',
  groupByGold: 'Gold',
  groupByGoldSize: 'Gold Size',
  groupByCombined: 'Combined',
  filterProductTypeLabel: 'Product Type',
  filterGoldLabel: 'Gold',
  filterGoldSizeLabel: 'Gold Size',
  otherGroupsLabel: 'Others',
  colGroup: 'Group',
  colPieceCount: 'Pieces',
  colAmountThb: 'Sales (THB)',
  colPercent: '% of Pieces',
  chartTooltip: '{pieces} pcs · {amount} THB',
  tableTotalLabel: 'Total {pieces} pcs · {amount} THB',
  productGroupNote: 'Amounts here = price after per-item discount, not yet netting special discount / freight / VAT at the invoice total',
  topDesignTitle: 'Best-selling designs',
  topDesignSortLabel: 'Sort by',
  topDesignSortPieces: 'Pieces',
  topDesignSortAmount: 'Amount',
  topDesignTotal: '{designs} designs · {pieces} pcs',
  topDesignPieces: '{count} pcs',
  topDesignAmount: '{amount} ฿',
  topDesignItems: '{count} items',
  topDesignShowMore: 'Show more (top {count})',
  topDesignShowLess: 'Show less',
  topDesignOpenDetail: 'View design {code}',
  topDesignNote: 'Designs are grouped by mold code ignoring the metal-color suffix (trailing W = White Gold, PG = Pink Gold, -SIL = Silver) — same design, different item · Click a card to view items separately',
  detailTitle: 'Design {code}',
  detailSummary: 'Total {pieces} pcs · {amount} THB · {items} item(s)',
  detailMoldCodes: 'Mold codes',
  colImage: 'Image',
  colStockNumberOld: 'Production No. (Old)',
  colStockNumberNew: 'Production No. (New)',
  colMold: 'Mold Code',
  colColor: 'Color',
