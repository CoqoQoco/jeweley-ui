...
export const invoiceDetail = {
  ...
  paymentSectionTitle: 'การชำระเงิน',
  ...
  paymentStatusPaid: 'ชำระครบแล้ว',
  paymentStatusPartial: 'ชำระบางส่วน',
  paymentStatusUnpaid: 'ยังไม่ชำระ',
  paymentProgressLine: 'ชำระแล้ว {paid} / {total}',
  freightInsuranceRow: 'ค่าขนส่ง / ประกันภัย',
  vatPercentRow: 'VAT {percent}%',
  moneySummaryFootnote: "สกุล {currency} {'@'} {rate} · ปัดขึ้น {rounding}",
  moneySummaryToggle: 'ดูรายละเอียดสรุปยอดเงิน',
  ...
  previewTitleWithPaper: 'ดูตัวอย่างก่อนพิมพ์ — {paper}',
  previewZoomLabel: 'ซูม',
  previewZoomFit: 'พอดีความกว้าง',
  previewPageLabel: 'หน้า {current}/{total}',
  previewGridToggle: 'แสดงเส้นกริด',
  previewPrintNowBtn: 'พิมพ์จริง',
  previewOffsetLabel: 'ระยะเลื่อน X: {x} มม. / Y: {y} มม.',
  ...
  success: {
    ...
    summaryPdf: 'สร้างใบสรุปตามประเภทสินค้า PDF สำเร็จ',
    summaryExcel: 'Export Excel ใบสรุปตามประเภทสินค้าสำเร็จ',
    cancelInvoice: 'ยกเลิก Invoice สำเร็จ',
    cancelInvoiceTitle: 'Invoice ได้ถูกยกเลิกแล้ว',
    cancelInvoiceUnconfirmTitle: 'Invoice ได้ถูกยกเลิกและปลดยืนยันสินค้าแล้ว',
    cancelInvoiceUnconfirm: 'ยกเลิก Invoice และปลดยืนยันสินค้า {count} รายการเรียบร้อยแล้ว',
  ...
  confirm: {
    ...
    cancelPaymentWarning: 'ใบนี้มีการรับชำระเงินอยู่ {amount} {currency} จะถูกยกเลิกไปด้วย',
    cancelIrreversible: 'ทำแล้วย้อนกลับไม่ได้',
    deletePayment: 'ลบประวัติการชำระเงิน {amount} {currency}',
    deletePaymentTitle: 'คุณต้องการลบประวัติการชำระเงินนี้หรือไม่?'
  },
  confirmOverpayTitle: 'ยืนยันจำนวนเงินเกินยอดคงค้าง',
  confirmOverpayMsg: 'จำนวนเงินที่กรอก {amount} {unit} มากกว่ายอดคงค้าง {outstanding} {unit} ต้องการดำเนินการต่อหรือไม่ครับ?',
...
export const quotation = {
  ...
  success: {
    ...
    exportSummaryExcel: 'Export Excel ใบสรุปตามประเภทสินค้าสำเร็จ',
  ...
  costCheckBtn: 'ตรวจต้นทุน',
  summaryBtn: 'ใบสรุปตามประเภท',
  summaryExcelBtn: 'Excel ใบสรุปตามประเภท',
  summaryTitle: 'ใบสรุปตามประเภทสินค้า',
  profitPercent: 'Service Fee %',
  excelBtn: 'Excel',
  cifLabel: 'C.I.F',
...
export const saleOrder = {
  ...
  salePerson: 'ผู้ขาย (SALE)',
  saleSupport: 'ผู้ช่วยขาย (SUPPORT)',
  selectSalePersonPlaceholder: 'เลือกหรือพิมพ์ชื่อ',
  currency: 'สกุลเงิน',
  currencyRate: 'อัตราแลกเปลี่ยน',
  customerName: 'ชื่อลูกค้า',
  ...
  maxDeposit: 'สูงสุด',
  depositApplyLabel: 'หักมัดจำ',
  depositBalanceHint: 'มัดจำคงเหลือของใบสั่งขาย {balance}',
  paymentMethod: 'วิธีการชำระเงิน',
  ...
  qtyAvailableCol: 'พร้อมขาย',
  qtyAvailableHint: 'พร้อมขาย {n}',
  qtyShortage: 'ขาด {k}',
  qtySoldOut: 'หมด',
  shortageWarningTitle: 'รายการที่จำนวนเกินพร้อมขาย',
  shortageWarningLine: '{stockNumber} ({origin}) ขาด {shortage} ชิ้น',
  btnAdjustToAvailable: 'ปรับจำนวนเท่าที่มี',
  ...
  fillFromStockModalTitle: 'เติมของจากคลัง',
  fillFromStockStockNumberLabel: 'เลขสินค้า (สแกน/กรอก)',
  ...
  confirm: {
    ...
    adjustToAvailableTitle: 'ยืนยันปรับจำนวนเท่าที่มี',
    adjustToAvailableMessage: 'ระบบจะปรับจำนวนสินค้าที่ขาด {count} รายการเท่าที่มีของ เช่น {stockNumber} จาก {oldQty} เป็น {newQty} ชิ้น และเพิ่มส่วนที่ขาดเป็นรายการรอผลิต/รอแปลงให้อัตโนมัติครับ',
...
export const soDeposit = {
  sectionTitle: 'มัดจำ',
  totalReceived: 'รับมัดจำรวม',
  totalApplied: 'หักเข้าใบแจ้งหนี้แล้ว',
  balance: 'คงเหลือ',
  percentOfTotal: '{percent}% ของยอดใบสั่งขาย',
  receiveBtn: 'รับมัดจำ',
  printReceiptBtn: 'พิมพ์ใบรับมัดจำ',
  deleteBtn: 'ลบ',
  showDeletedToggle: 'แสดงรายการที่ยกเลิก',
  emptyList: 'ยังไม่มีการรับมัดจำ',
  colDate: 'วันที่',
  colAmount: 'จำนวนเงิน',
  colMethod: 'วิธีชำระ',
  colBankRef: 'ธนาคาร / เลขที่อ้างอิง',
  colSlip: 'สลิป',
  colRemark: 'หมายเหตุ',
  colApplied: 'หักแล้ว',
  colRemaining: 'คงเหลือ',
  colAppliedInvoices: 'หักเข้าใบแจ้งหนี้',
  deletedBadge: 'ยกเลิกแล้ว',
  deletedReasonPrefix: 'เหตุผล',
  appliedLockHint: 'หักเข้าใบแจ้งหนี้แล้ว ลบไม่ได้',
  noPermissionHint: 'ไม่มีสิทธิ์จัดการมัดจำ',

  modalTitle: 'รับมัดจำ',
  soGrandTotalLabel: 'ยอดรวมใบสั่งขาย',
  quickFillHint: 'เติมจำนวนอย่างเร็ว',
  quickFill30: '30%',
  quickFill50: '50%',
  depositDateLabel: 'วันที่รับมัดจำ',
  amountLabel: 'จำนวนเงินมัดจำ',

  deleteReasonTitle: 'เหตุผลการลบรายการมัดจำ',
  deleteReasonLabel: 'เหตุผล',
  deleteReasonPlaceholder: 'ระบุเหตุผลที่ต้องการลบรายการมัดจำนี้',

  validation: {
    dateRequired: 'กรุณาเลือกวันที่รับมัดจำ',
    amountRequired: 'กรุณากรอกจำนวนเงินมัดจำให้มากกว่า 0',
    methodRequired: 'กรุณาเลือกวิธีการชำระเงิน',
    bankRequired: 'กรุณาเลือกธนาคาร',
    branchRequired: 'กรุณากรอกสาขาธนาคาร',
    compressError: 'ไม่สามารถบีบอัดรูปภาพได้',
    deleteReasonRequired: 'กรุณาระบุเหตุผลการลบรายการมัดจำ'
  },
  confirm: {
    deleteMessage: 'ลบรายการมัดจำ {amount} {currency} วันที่ {date}',
    deleteTitle: 'ยืนยันการลบรายการมัดจำนี้หรือไม่?'
  },
  success: {
    create: 'บันทึกรับมัดจำสำเร็จ',
    delete: 'ลบรายการมัดจำสำเร็จ'
  }
}
...
export const costStock = {
  ...
  alloyGoldLossTooltip: 'น้ำหนักโลหะผสม (Alloy) รวม Gold Loss ไว้แล้ว จึงไม่ต้องคิดซ้ำ',
  costPrefix: 'ต้นทุน',
  historyBadge: 'เคยใช้',
  gradeSyncTitle: 'พบเกรดเพชรเปลี่ยนแปลง',
  gradeSyncDetail: 'แถวที่ {count}: "{from}" จะเปลี่ยนเป็น "{to}"',
  gradeSyncApply: 'อัปเดตให้ตรงกัน',
  gradeSyncDismiss: 'ปิด',
  gradeSyncManualHint: 'เกรดเพชรถูกแก้แล้ว แต่แถวนี้ต้องแก้ข้อความเอง',
  gradeSyncDone: 'อัปเดตเกรดเพชรในตารางประเมินราคาเรียบร้อย',
...
export const pipelineDashboard = {
  title: 'ภาพรวมยอดขาย',
  subtitle: 'ยอดขายตามวันที่ออกบิล · แปลงเป็นบาท',
  searchTitle: 'ค้นหาภาพรวมยอดขาย',
  searchDesc: 'กรองยอดขายตามวันที่ออกบิล จุดขาย และลูกค้า',
  dateRangeLabel: 'วันที่ออกบิล',
  channelLabel: 'จุดขาย',
  channelNotSpecified: 'ไม่ระบุจุดขาย',
  customerLabel: 'ลูกค้า',
  customerPlaceholder: 'ค้นหาชื่อลูกค้า',
  customerOptionInvoiceCount: '{count} บิล',
  summaryTitle: 'ยอดขาย (บาท)',
  kpiTotalAmount: 'ยอดขายรวม',
  kpiTotalAmountSub: 'แปลงบาทตามเรทของบิล',
  kpiPaidAmount: 'รับชำระแล้ว',
  kpiPaidAmountSub: 'ครบแล้ว {count} บิล',
  kpiOutstandingAmount: 'ค้างชำระ',
  kpiOutstandingAmountSub: '{count} บิล',
  kpiInvoiceCount: 'จำนวนบิล',
  kpiInvoiceCountSub: '{count} ชิ้น',
  uncomputableNote: 'มี {count} บิลเก่าที่ไม่มียอดรวม ไม่นับในยอดเงิน',
  overpaidNote: 'มี {count} บิลที่บันทึกรับชำระเกินยอดบิล รวม {amount} บาท — ตรวจสอบการบันทึกรับชำระ',
  productGroupTitle: 'กลุ่มสินค้าขายดี',
  groupByLabel: 'แยกตาม',
  groupByProductType: 'ประเภทสินค้า',
  groupByGold: 'ทอง',
  groupByGoldSize: 'ขนาดทอง',
  groupByCombined: 'รวม',
  filterProductTypeLabel: 'ประเภทสินค้า',
  filterGoldLabel: 'ทอง',
  filterGoldSizeLabel: 'ขนาดทอง',
  otherGroupsLabel: 'อื่นๆ',
  colGroup: 'กลุ่ม',
  colPieceCount: 'จำนวนชิ้น',
  colAmountThb: 'ยอดขาย (บาท)',
  colPercent: '% ของจำนวนชิ้น',
  chartTooltip: '{pieces} ชิ้น · {amount} บาท',
  tableTotalLabel: 'รวม {pieces} ชิ้น · {amount} บาท',
  productGroupNote: 'ยอดในกล่องนี้ = ราคาหลังส่วนลดรายชิ้น ยังไม่หักส่วนลดพิเศษ/ค่าขนส่ง/VAT ท้ายบิล',
  topDesignTitle: 'สินค้าขายดีตามแบบ',
  topDesignSortLabel: 'เรียงตาม',
  topDesignSortPieces: 'จำนวนชิ้น',
  topDesignSortAmount: 'ยอดเงิน',
  topDesignTotal: '{designs} แบบ · {pieces} ชิ้น',
  topDesignPieces: '{count} ชิ้น',
  topDesignAmount: '{amount} ฿',
  topDesignItems: '{count} item',
  topDesignShowMore: 'ดูเพิ่ม ({count} อันดับ)',
  topDesignShowLess: 'แสดงน้อยลง',
  topDesignOpenDetail: 'ดูรายละเอียดแบบ {code}',
  topDesignNote: 'นับรวมตามแบบ: รหัสแม่พิมพ์ที่ต่างกันแค่สี (ท้าย W = ทองขาว, PG = ทองพิงค์, -SIL = เงิน) นับเป็นแบบเดียวกัน · กดการ์ดเพื่อดูแยกราย item',
  detailTitle: 'แบบ {code}',
  detailSummary: 'รวม {pieces} ชิ้น · {amount} บาท · {items} item',
  detailMoldCodes: 'รหัสแม่พิมพ์',
  colImage: 'รูป',
  colStockNumberOld: 'เลขที่ผลิต (เก่า)',
  colStockNumberNew: 'เลขที่ผลิต (ใหม่)',
  colMold: 'รหัสแม่พิมพ์',
  colColor: 'สี',
  colGoldSize: 'ขนาดทอง',
  colSku: 'SKU',
  colSize: 'ไซส์'
