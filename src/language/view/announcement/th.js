export default {
  feed: {
    ...
    emptyHint: 'เมื่อมีข่าวสารจากบริษัท จะแสดงที่นี่เป็นที่แรกครับ',
    emptyHintManager: 'เริ่มต้นด้วยการสร้างประกาศแรกให้ทุกคนเห็นบนหน้าแรกครับ',
    createFirst: 'สร้างประกาศแรก',
    tipPin: 'ปักหมุดเรื่องสำคัญไว้บนสุด',
    tipSchedule: 'ตั้งเวลาแสดงล่วงหน้าและวันหมดอายุ',
    tipImage: 'แนบรูปประกอบได้ 1 รูป',
