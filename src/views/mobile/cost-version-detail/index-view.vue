  ...
  methods: {
    ...
    async handleExportPDF() {
      ...
      try {
        ...
        const pdfOptions = {
          ...(this.hasCurrencyConversion ? { currencyUnit: this.currencyUnit, currencyRate: this.currencyRate } : {}),
          ...(this.costVersion?.customStockInfo?.length ? { customStockInfo: this.costVersion.customStockInfo } : {})
        }
