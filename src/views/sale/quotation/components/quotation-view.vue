  ...
  <div class="mt-2">
    <form @submit.prevent="onSave">
      ...
      <quotation-items-table
        :customer="customer"
        :sumNetWeight="Number(sumNetWeight)"
        :sumGoldWeight="Number(sumGoldWeight)"
        :sumDiamondWeight="Number(sumDiamondWeight)"
        :sumGemWeight="Number(sumGemWeight)"
        :sumAppraisalPrice="Number(sumAppraisalPrice)"
        :sumDiscountPrice="Number(sumDiscountPrice)"
        :sumConvertedPrice="Number(sumConvertedPrice)"
        :sumQty="Number(sumQty)"
        :sumTotalConvertedPrice="Number(sumTotalConvertedPrice)"
        :totalAfterDiscountAndAddition="Number(totalAfterDiscountAndAddition)"
        ...
        @blur-qty="onBlueQty($event.data, $event.index, $event.fieldName)"
        @blur-freight="onBlueFreight"
        @update:freight="customer.freight = $event"
        @update:vat-percent="customer.vatPercent = $event"
        @update:special-discount="customer.specialDiscount = $event"
        @update:special-addition="customer.specialAddition = $event"
      />
