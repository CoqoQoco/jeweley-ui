  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          field: 'nameEn',
          header: this.$t('view.master.diamondGrade.field.nameEn'),
          sortable: true,
          minWidth: '150px'
        },
        {
          field: 'nameTh',
          header: this.$t('view.master.diamondGrade.field.nameTh'),
          sortable: true,
          minWidth: '150px'
        },
        {
          field: 'description',
          header: this.$t('view.master.diamondGrade.field.description'),
          sortable: true,
          minWidth: '150px'
        }
      ]
