<template>
  <div>
    <modal :showModal="isShow" @closeModal="closeModal" width="500px" :isShowActionPart="true">
      <template #title>
        <span class="title-text-lg px-3 pt-3 d-block">เพิ่มขนาดทอง</span>
      </template>
      ...
      <template #action>
        <button class="btn btn-sm btn-main" type="submit" form="form-gold-size-create">
...
export default {
  ...
  data() {
    return {
      ...
      //wording
      txtConfirmSubmit: 'ยืนยันเพิ่มขนาดทอง'
    }
  },
