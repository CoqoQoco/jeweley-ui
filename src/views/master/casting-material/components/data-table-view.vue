  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          field: 'code',
          header: this.$t('view.master.castingMaterial.field.code'),
          sortable: true,
          minWidth: '150px'
        },
        {
          field: 'nameEn',
          header: this.$t('view.master.castingMaterial.field.nameEn'),
          sortable: true,
          minWidth: '150px'
        },
        {
          field: 'nameTh',
          header: this.$t('view.master.castingMaterial.field.nameTh'),
          sortable: true,
          minWidth: '150px'
        },
        {
          field: 'description',
          header: this.$t('view.master.castingMaterial.field.description'),
          sortable: true,
          minWidth: '150px'
        }
      ]
