    ...
    <modal :showModal="isShow" @closeModal="closeModal">
      <template v-slot:content>
        <form @submit.prevent="onSubmit">
          <div class="mt-3">
            <stepperStatus :events="events" :eventsIdActive="3"></stepperStatus>
          </div>
          ...
          <div class="form-col-container mt-2">
            <div>
              ...
              <input class="form-control" v-model="form.castBy" type="text" required />
            </div>
            <div>
              <div>
  ...
  methods: {
    ...
    async submit() {
      try {
        ...
        params.append('castBy', this.form.castBy)
        ...
        const res = await api.jewelry.post('Mold/PlanCastingSilver', params, options)
        if (res) {
          swAlert.success(
            ``,
            '',
