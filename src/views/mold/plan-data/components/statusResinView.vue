      ...
      <div class="col-4">
        <div class="contaianer-image">
          <div class="title-text">
            ...
            <span>รูปปริ้นเรซื่น</span>
          </div>
          <div v-if="stringToArray(resin?.image).length" class="contaianer-image-show">
            <div v-for="(img, index) in stringToArray(resin?.image)" :key="index">
              <imagePreview :imageName="img" type="PLANMOLDRESIN" :width="100" :height="100" />
            </div>
          </div>
        </div>
      </div>
