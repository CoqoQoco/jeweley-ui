      ...
      <div class="col-4">
        <div class="contaianer-image">
          <div class="title-text">
            ...
            <span>รูปหล่อพิมพ์เงิน</span>
          </div>
          <div v-if="stringToArray(casting?.image).length" class="contaianer-image-show">
            <div v-for="(img, index) in stringToArray(casting?.image)" :key="index">
              <imagePreview
                :imageName="img"
                type="PATH"
