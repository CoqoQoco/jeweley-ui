      ...
      <template v-slot:content>
        <form @submit.prevent="onSubmit">
          <div class="title-text-lg-bg">
            <span class="title-text-white">{{ $t('planUpdate.addMaterial') }}</span>
          </div>
          <div class="p-2">
            ...
            <div class="form-col-container">
              <div>
                <span class="title-text">{{ $t('planUpdate.goldColor') }}</span>
                <DropdownGeneric
              ...
              <div class="form-content-row-sub-container">
                <div>
                  <span class="title-text">{{ $t('planUpdate.goldPercent') }}</span>
                  <DropdownGeneric
                ...
                <div>
                  <span class="title-text">{{ $t('planUpdate.goldQty') }}</span>
            ...
            <div class="form-col-container">
              <div>
                <span class="title-text">{{ $t('planUpdate.gemType') }}</span>
                <DropdownGeneric
                  :modelValue="form.gem"
                  :options="masterGem"
                  optionLabel="description"
              ...
              <div>
                <span class="title-text">{{ $t('planUpdate.gemShape') }}</span>
                <DropdownGeneric
            ...
            <div class="form-col-container">
              <div>
                <span class="title-text">{{ $t('planUpdate.gemSize') }}</span>
                <InputTextGeneric v-model="form.gemSize" />
              </div>
              <div class="form-content-row-sub-container">
                <div>
                  <span class="title-text">{{ $t('planUpdate.gemQty') }}</span>
                  <InputTextGeneric v-model.number="form.gemQty" type="number" :min="1" />
                </div>
                <div>
                  <span class="title-text">{{ $t('planUpdate.gemUnit') }}</span>
            ...
            <div class="form-col-container">
              <div>
                <span class="title-text">{{ $t('planUpdate.diamondSize') }}</span>
                <InputTextGeneric v-model="form.diamondSize" />
              </div>
              <div class="form-content-row-sub-container">
                <div>
                  <span class="title-text">{{ $t('planUpdate.diamondWeight') }}</span>
                  <InputTextGeneric v-model="form.diamondWeight" />
                </div>
                <div>
                  <span class="title-text">{{ $t('planUpdate.diamondWeightUnit') }}</span>
            ...
            <div class="form-col-container">
              <div>
                <span class="title-text">{{ $t('planUpdate.diamondQuality') }}</span>
                <InputTextGeneric v-model="form.diamondQuality" />
              </div>
              <div class="form-content-row-sub-container">
                <div>
                  <span class="title-text">{{ $t('planUpdate.diamondQty') }}</span>
                  <InputTextGeneric v-model.number="form.diamondQty" type="number" :min="1" />
                </div>
                <div>
                  <span class="title-text">{{ $t('planUpdate.diamondUnit') }}</span>
                  <InputTextGeneric v-model="form.diamondUnit" />
                </div>
              </div>
            </div>
            <div class="submit-container">
              <ButtonGeneric variant="green" icon="bi-calendar-check" type="submit" />
            </div>
          </div>
        </form>
      </template>
