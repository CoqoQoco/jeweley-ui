<template>
  <SearchBarGeneric
    :title="$t('view.production.castLossTrend.searchTitle')"
    :description="$t('view.production.castLossTrend.searchDesc')"
    @search="onSearch"
  >
    <template #fields>
      <div>
        <span class="title-text">{{ $t('view.production.castLossTrend.monthRange') }}</span>
        <DateRangeGeneric
...
export default {
  name: 'CastLossTrendReportSearchView',
