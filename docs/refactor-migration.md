...
| **mold** | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 23 | |
| **production-cost** | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 24 | |
| **production/plan-update** | 🔄 | ⬜ | ⬜ | ⬜ | ✅ | 20* | Pass A (view/ ครบ 10 ไฟล์): *20 primevue exceptions (eslint-disable ครบ); swAlert default→named imports ทุกไฟล์; try-catch/isLoading/console.log removed ทุกไฟล์; btn-secondary/warning/primary→valid classes ทุกไฟล์; dead commented code removed (melt-view); operator precedence bug fixed (price-view) |
